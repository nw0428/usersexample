...
class PaintingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post paintings_url, params: { painting: { artist: @painting.artist, height_cm: @painting.height_cm, title: @painting.title, width_cm: @painting.width_cm, year: @painting.year } }
    end
  ...
  test "should update painting" do
    patch painting_url(@painting), params: { painting: { artist: @painting.artist, height_cm: @painting.height_cm, title: @painting.title, width_cm: @painting.width_cm, year: @painting.year } }
